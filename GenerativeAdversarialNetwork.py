...
train_images = train_images.reshape(train_images_shape[0], 28, 28, 1).astype('float32')
...
def train_step(images):
    ...
    discriminator.optimizer.apply_gradients(zip(gradients_of_discriminator, discriminator.variables))
